...
SSP_RESULTS_PATH = dir_path.joinpath("ssp_modeling/ssp_run_output/sisepuede_run_2025-08-21T18;46;49.258574")
SSP_RUN = "libya.csv"
SSP_CB = dir_path.joinpath("ssp_modeling/cb")

# Load data
ssp_data = pd.read_csv(os.path.join(SSP_RESULTS_PATH, SSP_RUN))
...
CB_DEFAULT_DEFINITION_PATH = os.path.join(SSP_CB, "cb_cost_factors")
...
# Save the results
results_all_pp_shifted.to_csv(os.path.join(SSP_CB, "cb_results/cba_resultados.csv"), index = False)